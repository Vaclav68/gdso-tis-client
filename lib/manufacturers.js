...
export const MANUFACTURERS = {
    ...
    '086699': {
        name: 'Michelin',
        country: 'FR',
        urlPattern: '{baseUrl}/{sgtin}',  // Michelin n'utilise PAS /tire/ dans l'URL
        encodeSgtin: true,
        headers: {},
    ...
    // ========================================================================
    // GOODYEAR - URL: {baseUrl}/{sgtin} SANS encodage
    // ========================================================================
    '54520007': {
        name: 'Goodyear',
        country: 'EU',
        urlPattern: '{baseUrl}/{sgtin}',  // Goodyear n'utilise PAS /tire/ et PAS d'encodage
        encodeSgtin: false,
        headers: {},
        transformResponse: null
    },
